  ...
  it('cannot create a reports document with an invalid report objects', function () {
    ...
    businessSyncSpecHelper.verifyDocumentNotCreated(
      ...
      [
        ...
        errorFormatter.enumPredefinedValueViolation('reports[0].type', [ 'balance-sheet', 'cash-flow', 'general-ledger', 'insights', 'inventory-on-hand', 'product-purchases-sales', 'profit-and-loss', 'sales-tax', 'trial-balance' ]),
